...
--     fname VARCHAR(100),
--     lname VARCHAR(100),
--     position VARCHAR(100) CHECK(position IN('Assistant','Supervisor', 'Manager')),
--     sex VARCHAR(1),
--     dob DATE,
--     salary INTEGER CHECK(salary < 200000 and salary > 0),
--     branchno VARCHAR(10),
...
--     lname VARCHAR(100),
--     address VARCHAR(100),
--     telno VARCHAR(100) CHECK(LENGTH(telno) > 10),
...
--     staffno VARCHAR(10),
--     branchno VARCHAR(10),
--     FOREIGN KEY (ownerno) REFERENCES privateowner(ownerno) ON UPDATE CASCADE,
--     FOREIGN KEY (staffno) REFERENCES staff(staffno) ON UPDATE CASCADE,
--     FOREIGN KEY (branchno) REFERENCES branch(branchno) ON UPDATE CASCADE
-- );

-- CREATE TABLE viewing (
--     view_id VARCHAR(10) PRIMARY KEY NOT NULL,
--     clientno VARCHAR(10),
--     propertyno VARCHAR(10),
--     viewdate DATE,
--     comment TEXT CHECK(LENGTH(comment) < 500),
--     FOREIGN KEY (clientno) REFERENCES client(clientno) ON UPDATE CASCADE,
--     FOREIGN KEY (propertyno) REFERENCES propertyforrent(propertyno) ON UPDATE CASCADE
-- );

-- CREATE TABLE registration (
--     reg_id VARCHAR(10) PRIMARY KEY NOT NULL,
--     clientno VARCHAR(10),
--     branchno VARCHAR(10),
--     staffno VARCHAR(10),
--     datejoined DATE,
